    ...
    return (
        ...
        >
            <div className="flex rounded-full bg-gradient-to-br from-gray-300 to-gray-200 dark:from-gray-600 dark:to-gray-800">
                ...
                <span className="m-1 flex cursor-pointer content-center items-center justify-center rounded-full transition-all ease-in-out hover:bg-slate-500/20 dark:hover:bg-slate-50/20">
